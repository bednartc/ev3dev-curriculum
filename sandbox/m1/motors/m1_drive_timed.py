...
Authors: David Fisher and Travis Bednarek.
...
#     200 degrees / second  -->  traveled 25 inches  -->  2.5 inches / second
#     300 degrees / second  -->  traveled 34 inches  -->  3.4 inches / second
...
#     900 degrees / second  -->  traveled 48 inches  -->  9.6 inches / second (probably no faster than 800)
#
...
def main():
    ...
    while time_s != 0:
        ...
        time.sleep((0.11 * left_sp) / distance_s)
        left_motor.stop()
